...
import static ClubProgramacion.Ventana.fileWriter;
...
public class Ventana extends JFrame {
    ...
    JLabel label_NU,/*Etiquetas para poder poner texto*/
            ...
            label_MJ,
            label_GA;
    Empleado miEmpleado; //declaramos el objeto  'miPortero ' de la clase Portero.
    Persona personas[];//declaramos el arreglo  'jugadorInde ' de la clase Jugador.
    ...
    public Ventana() {/*Constructor de la clase ,
      El utilizar el contructor de una clase nos da la ventaja de ser la primera cosa que se ejecuta cuando un objeto es creado. 
        ...
        personas = new Persona[4];  //declaramos el arreglo  'jugadorInde ' de la clase Jugador.
    ...
    private void iniciarComponentes() {
        ...
        radio_P = new JRadioButton("Empleado.");//Declaramos los botonoes de radio.
        ...
        radio_M = new JRadioButton("Gerente");
        radio_M.setPreferredSize(new Dimension(200, 45));
        radio_Del = new JRadioButton("Secretaria.");
...
//        panelSuperiorS.setBackground(Color.red);
        ...
        setTitle("Empresa .");/*Metodo para ponerle ttulo a nuestra ventana.*/
    ...
    private void radio_PCambio(ChangeEvent e) {
        if (radio_P.isSelected()) {/*comprobamos si el elemento a sido seleccionado */
            texto_GA.setEnabled(true);/*si fuel abilitado, desabilitamos la caja de texto para los goles */
        } else {
 ...
 /*Al pasarle los parametros estamos rellenanado los atributos del objeto 'miPortero'  */
            miEmpleado = new Empleado(texto_Nom.getText(), texto_MJ.getText(), Integer.parseInt(texto_NU.getText()), Integer.parseInt(texto_GA.getText()));
            
        } else if (radio_D.isSelected()) {
            //El primer objeto del arreglo equibaldra a el defensa del equipo.
            personas[0] = new Persona(texto_Nom.getText(), texto_MJ.getText(), Integer.parseInt(texto_NU.getText()), Integer.parseInt(texto_GA.getText()));
        } else if (radio_M.isSelected()) {
            //El segundo objeto del arreglo equibaldra a el Medio campista del equipo.
            personas[1] = new Persona(texto_Nom.getText(), texto_MJ.getText(), Integer.parseInt(texto_NU.getText()), Integer.parseInt(texto_GA.getText()));
        } else if (radio_Del.isSelected()) {
            //El tercer objeto del arreglo equibaldra a el Delantero del equipo.
            personas[2] = new Persona(texto_Nom.getText(), texto_MJ.getText(), Integer.parseInt(texto_NU.getText()), Integer.parseInt(texto_GA.getText()));
        } else {
    ...
    public static void crear_archivo() {
        ...
        try {
            ...
            fileWriter = new FileWriter("PersonalEmpresa.txt");
    ...
    private void botonMDAP(ActionEvent e) {
        if (radio_P.isSelected()) {
            JOptionPane.showMessageDialog(null, miEmpleado);//Con solo poner el nombre del objeto, este invocara en metodo 'toString'.
        } else if (radio_D.isSelected()) {
